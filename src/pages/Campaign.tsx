    ...
    <div className="max-w-[1350px] mx-auto space-y-5 animate-fade-in">
      ...
      <div className="bg-white dark:bg-[#1a1f2e] rounded-2xl border border-[#E2E8F0] dark:border-[#2a3042] overflow-hidden">
        <div className="flex items-center gap-3 px-6 py-5 border-b border-[#F1F5F9] dark:border-[#2a3042]">
          ...
          <h2 className="text-[16px] font-semibold text-[#0F172A] dark:text-white">New Campaign</h2>
        </div>
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="space-y-1.5 relative">
            {/* Subtle mosque watermark behind editor */}
            <div className="absolute -right-4 -bottom-4 w-[180px] h-[120px] opacity-[0.035] dark:opacity-[0.05] pointer-events-none select-none" aria-hidden="true">
              <svg viewBox="0 0 600 300" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
                <ellipse cx="300" cy="120" rx="90" ry="70" fill="#2563EB" />
                <path d="M300 42 c6 0 11 8 8 16 c-2 5-7 8-8 8 c-1 0-6-3-8-8 c-3-8 2-16 8-16z" fill="#2563EB" />
                <rect x="140" y="60" width="24" height="180" rx="4" fill="#2563EB" />
            ...
            <Textarea
              ...
              maxLength={1000}
              className="relative min-h-[120px] rounded-[10px] text-[13px] border-[#E2E8F0] dark:border-[#2a3042] focus:ring-[#2563EB]/20 focus:border-[#2563EB] resize-none bg-white dark:bg-[#141925]"
            />
          </div>
          ...
          <div className="flex items-center justify-between pt-1">
            {msg && (
              <span className={`text-[13px] font-medium ${msg.includes('Sent') ? 'text-[#10B981]' : 'text-[#EF4444]'}`}>{msg}</span>
            )}
